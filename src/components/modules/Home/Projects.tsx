          ...
          {displayProjects.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-12">
              {displayProjects.map((project, index) => {
                // thumbnail ভেরিয়েবলের প্রয়োজন নেই, লজিক সরাসরি Image-এ ব্যবহার করা হলো।
                // const thumbnail =
                ...
                return (
                  ...
                  >
                    <Image
                      // URL না থাকলে বা ভুল হলে, notFoundImg.src ব্যবহার করবে
                      src={project.thumbnail || notFoundImg.src}
                      alt={project.title}
                      width={500}
                      height={300}
                      unoptimized // এটি অপশনাল, আপনার কনফিগারেশন অনুযায়ী রাখুন
                      // লোড হতে ব্যর্থ হলে (যেমন ভুল URL-এর কারণে), সোর্স পরিবর্তন করে notFoundImg করে দেবে
                      onError={(e) => {
